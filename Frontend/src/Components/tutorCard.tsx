...
const TutorProfileCard: React.FC<TutorProfileCardProps> = ({ fullName, username, id, subject, yearsOfExp, monthlyFee, profilePic }) => {
    return (
        <div className="w-full max-w-sm bg-[#f7f5fd] border border-gray-200 rounded-lg shadow">
            <div className="flex justify-end px-4 pt-4">
            </div>
            <div className="flex flex-col items-center pb-10">
            <img className="w-40 h-40 mb-3 rounded-full shadow-lg border-2 border-purple-500"
