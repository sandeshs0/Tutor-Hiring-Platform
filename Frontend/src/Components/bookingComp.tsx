...
const BookingForm: React.FC<BookingFormProps> = ({ fullName, username, bio, subject, yearsOfExp, monthlyFee, profilePic,id ,address, availability}) => {
  return (
    <>
    <div className="flex bg-gray-100 mt-24">
          <div className="m-auto">
              <div>
                  ...
                  >
                      <span className="pl-2 mx-1">Confirm your Booking Request for {fullName} </span>
                  </button>
